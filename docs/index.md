...
The goal of this document is to create a unified database for research and applications on SR among which is to list all research works so this list will continue to evolve. This living review was proposed in the mentioned review in analogy with HEP ML Living Review ([link](https://iml-wg.github.io/HEPML-LivingReview/)).*
