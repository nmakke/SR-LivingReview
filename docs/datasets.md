...
| <div style="width:100px">Category</div> | <div style="width:170px">Underlying model</div> | <div style="width:110px">Benchmark name</div> | <div style="width:160px">Reference</div> | <div style="width:100px">problems</div> | <div style="width:50px">year</div> |
| -------- | ------- | ------- | ------- | ----- | ----- | 
