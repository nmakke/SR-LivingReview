...
| Category | <div style="width:200px">Underlying model</div> | <div style="width:140px">Benchmark name</div> | <div style="width:140px">Reference</div> | Number of problems | <div style="width:100px">year</div> |
| -------- | ------- | ------- | ------- | ----- | ----- | 
